...
/*
Below is one of the examples in the kudu example git repo... It has only been modified to have the master kudu url hardcoded
It requires that a table is already created for it to run.
 */
public class InsertLoadgen {
    ...
    public static void main(String[] args) {
        if (args.length != 3) {
            System.err.println("Usage: InsertLoadgen kudu_table num_threads");
            System.exit(1);
        }

        final String masterHost = "127.0.0.1:64046";
